...
namespace mlp.Migrations
{
    ...
    [Migration("20200219150332_SecondMigration")]
            ...
            modelBuilder.Entity("mlp.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            Category = "Leader",
                            DateTimeGroup = new DateTime(2020, 2, 19, 10, 3, 31, 414, DateTimeKind.Local).AddTicks(9023),
                        ...
                        new
                        {
                            ProductId = 2,
                            Category = "Pony",
                            DateTimeGroup = new DateTime(2020, 2, 19, 10, 3, 31, 417, DateTimeKind.Local).AddTicks(5097),
                        ...
                        new
                        {
                            ProductId = 3,
                            Category = "Pony",
                            DateTimeGroup = new DateTime(2020, 2, 19, 10, 3, 31, 417, DateTimeKind.Local).AddTicks(5185),
                        ...
                        new
                        {
                            ProductId = 4,
                            Category = "Pony",
                            DateTimeGroup = new DateTime(2020, 2, 19, 10, 3, 31, 417, DateTimeKind.Local).AddTicks(5191),
